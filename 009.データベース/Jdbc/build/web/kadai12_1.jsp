...
<html>
    ...
    <body>
        ...
        <form action="./kadai12" method="post">
            ...
            <Tr>
                <Td>名前</Td>       <Td><input type="text" name="txtName" value=""></Td> </Tr>
            <Tr>
            <Td>電話番号</Td>   <Td><input type="text" name="txtTell" value=""></Td> </Tr>
            <Tr>
            <Td>年齢</Td>       <Td><input type="text" name="txtAge" value=""></Td> </Tr>
            <Tr>
            <Td>誕生日</Td>     <Td><input type="text" name="txtBirthday" value=""></Td> </Tr>
            </Table>
